...
def move_folders():
    folder_list = [
        "mode2_location_semantic_0.0001_coef0.333000-0.333000_2022-11-12-20-57-32",
...
def main():
    ...
    parser.add_argument(
        ...
        "--eval_dir",
        type=str,
        default="experiments/mimic-diff/test_output/captions/test/test_results_location.json",
    ...
    if args.acc:
        ...
        results = caption_metric_by_question_type(
            input_file=args.eval_dir,
            target_type=args.target_type,
        )
    else:
        print("Evaluating all")
        results = caption_metric(
            input_file="experiments/temp/final/%s/eval_sents/eval_results_%s.json"
            % (args.run_name, str(args.checkpoint_num))
        )
