...
def build_optimizer(params, cfg):
    if cfg.train.optim.type == "rmsprop":
        return optim.RMSprop(
            params,
            cfg.train.optim.lr,
            cfg.train.optim.alpha,
            cfg.train.optim.epsilon,
            weight_decay=cfg.train.optim.weight_decay,
        )
    elif cfg.train.optim.type == "adagrad":
        return optim.Adagrad(
            params, cfg.train.optim.lr, weight_decay=cfg.train.optim.weight_decay
        )
...
class InfoNCELoss(nn.Module):
    def __init__(self, cfg):
        ...
        self.temperature = cfg.faiss.temperature
...
class MAELoss(nn.Module):
    ...
    def forward(self, bef, reconstructed_bef):
        batch_size = bef.shape[0]
        loss = torch.mean(torch.abs(reconstructed_bef - bef))
