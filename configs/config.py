...
__C.model.change_detector.coef_sem = 0.333
__C.model.change_detector.coef_spa = 0.333
__C.model.change_detector.num_hidden_layers = 2
...
__C.data.cmb_bbox_di_feats_path = "./feature_extraction/cmb_bbox_di_feats.hdf5"
__C.data.feature_mode = "location"
# RAG args
__C.data.use_reaug = True
__C.data.train_cmb_bbox_di_feats_path = "./data/train_cmb_bbox_di_feats.hdf5"
__C.data.faiss_nns_path = "./data/cmb_vqadiff_nns.hdf5"
__C.data.retrieval_cmb_train_path = "./data/retrieval_cmb_train.hdf5"
__C.data.retrieval_cmb_test_path = "./data/retrieval_cmb_test.hdf5"


__C.faiss = AttrDict()
__C.faiss.use_gpu = True
__C.faiss.reaug_k = 5
__C.faiss.nlist = 16384
__C.faiss.nprobe = 128
__C.faiss.faiss_m = 32
__C.faiss.vocab_json = "/home/dataset/vqadiff/feature_extraction/train_faiss_vocab_mimic_VQA.json"
__C.faiss.threshold = 0.0
__C.faiss.temperature = 0.1
__C.faiss.infonce = 0.5

__C.data.train = AttrDict()
__C.data.train.batch_size = 128
__C.data.train.seq_per_img = 1
__C.data.train.max_samples = None
__C.data.train.empty_image = False
